...
If you use DINOv3, make sure to correctly set the path to the DINOv3 weights in the `configs/dinomaly.yaml` file.
...
if __name__ == '__main__':
    ...
    parser.add_argument("--thumbnail_config", default = 'configs/dinomaly.yaml', type=str, help='Low-res(thumbnail) detection model configuration path')
    parser.add_argument("--detector_config_path", default = 'configs/dinomaly.yaml', type = str, help='High-res detection model configuration path')
    ...
    parser.add_argument("--checkpoint_root", default ='results/dinomaly_checkpoints', type = str, help='Directory for saving model checkpoints')
    parser.add_argument("--log_root", default = 'results/dinomaly_logs', type = str, help='Directory for saving logs')
    parser.add_argument("--vis_root", default = 'results/dinomaly_vis', type = str, help='Directory for saving visualization results')
